import Insert from '../../dist/insert-parameters';
...
describe('3 array', function() {
    ...
    describe('0 index', function() {
        ...
        let intersected = Insert<number|string>([1,2,3], ['a'], 0);
    ...
    describe('1 index', function() {
        ...
        let intersected = Insert<number|string>([1,2,3], ['a'], 1);
        it('intersected', () => {
    ...
    describe('2 index', function() {
        ...
        let intersected = Insert<number|string>([1,2,3], ['a'], 2);
        it('intersected', () => {
    ...
    describe('3 index (out of bound)', function() {
        ...
        let intersected = Insert<number|string>([1,2,3], ['a'], 3);
        it('intersected', () => {
    ...
    describe('4 index (out of bound)', function() {
        ...
        let intersected = Insert<number|string>([1,2,3], ['a'], 4);
        it('intersected', () => {
