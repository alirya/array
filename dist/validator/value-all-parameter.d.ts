 ...
 * @constructor
 */
export default function ValueAllParameter<BaseType = unknown, ValueType extends BaseType = BaseType, Validators extends Validator<BaseType, ValueType>[] = Validator<BaseType, ValueType>[], ReturnType extends Validatable = Validatable>({ validators, validation, }: StrictOmit<ValueAllArgument<BaseType, ValueType, Validators, ReturnType, any>, 'message'>): Value<BaseType, ValueType, InferMessage<ListReturn<Validators>>, Validators, ListReturn<Validators>, ReturnType>;
export default function ValueAllParameter<BaseType = unknown, ValueType extends BaseType = BaseType, Validators extends Validator<BaseType, ValueType>[] = Validator<BaseType, ValueType>[], ReturnType extends Validatable = Validatable, MessageType = unknown>({ validators, validation, message, }: Required<ValueAllArgument<BaseType, ValueType, Validators, ReturnType, MessageType>, 'message'>): Value<BaseType, ValueType, MessageType, Validators, ListReturn<Validators>, ReturnType>;
