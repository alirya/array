...
export declare type JoinParameterArgument<MessageType extends Message<string>[]> = Messages<MessageType> & Separator;
export default class JoinParameter<MessageType extends Message<string>[]> extends JoinParameters<MessageType> {
    constructor({ messages, separator, }: JoinParameterArgument<MessageType>);
}
