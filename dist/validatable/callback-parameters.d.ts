...
export default class CallbackParameters<ValidatableList extends ReadonlyArray<Validatable> = ReadonlyArray<Validatable>, Boolean extends boolean = boolean> implements Validatable, Validatables<ValidatableList> {
