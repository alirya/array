...
var _MapCallbackParameters_message, _MapCallbackParameters_value;
...
export default class MapCallbackParameters {
    ...
    get value() {
        return __classPrivateFieldGet(this, _MapCallbackParameters_value, "f").slice(0, this.validators.length);
    }
    get valid() {
...
_MapCallbackParameters_message = new WeakMap(), _MapCallbackParameters_value = new WeakMap();
__decorate([
    MemoizeAccessor()
